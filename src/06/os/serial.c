...
#define H8_3069F_SCI_SSR_RDRF   (1<<6) /* receive data register finish */
#define H8_3069F_SCI_SSR_TDRE   (1<<7) /* transmit data register end */
...
int serial_init(int index)
{
  ...
  sci->scr = 0;
  sci->smr = 0;
  sci->brr = 64; /* generate 9600bps from 20MHz clock (use 80 if 25Mhz clock) */
  sci->scr = H8_3069F_SCI_SCR_RE | H8_3069F_SCI_SCR_TE; /* receive and transmit enable */
  sci->ssr = 0;
